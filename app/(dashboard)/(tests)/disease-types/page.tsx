...
export default function DiseaseTypes() {
    const COLUMNS = [
        ...
        {
            title: 'Boshqarish', key: 'actions', render(item: DiseaseType) {
    ...
    return (
        <div>
            <DataTable
                ...
                topSlot={<Button onClick={() => setDialog(true)} size={'default'} className="w-full sm:w-fit">Kasallik turi yaratish</Button>}
            />

            <Dialog open={dialog} onOpenChange={handleClose}>
                <DialogContent style={{ maxHeight: '95vh', maxWidth: 500, overflow: 'auto' }} aria-describedby={undefined}>
                    <DialogHeader>
                        <DialogTitle>Kasallik turi yaratish</DialogTitle>
                    </DialogHeader>
                    <Form {...form}>
