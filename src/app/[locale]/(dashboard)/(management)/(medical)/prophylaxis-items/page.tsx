...
export default function ProphylaxisItems() {
  ...
  return (
    <div>
      <DataTable columns={columns} queryFunction={useGetProphylaxisItems} topSlot={<div className="grid gap-2 grid-cols-[50px_auto] w-full md:grid-cols-2 md:w-fit"><ExcelDownloadButton importUrl="/prophylaxis-items/import" />{createButton(t("pages.createProphylaxisItem"))}</div>} />
