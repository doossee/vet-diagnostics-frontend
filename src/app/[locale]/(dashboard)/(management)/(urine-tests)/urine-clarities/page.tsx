...
export default function UrineClarities() {
  ...
  return (
    <div>
      <DataTable columns={columns} queryFunction={useGetUrineClarities} topSlot={<div className="grid gap-2 grid-cols-[50px_auto] w-full md:grid-cols-2 md:w-fit"><ExcelDownloadButton importUrl="/urine-clarities/import" />{createButton(t("pages.createUrineClarity"))}</div>} />
